...
const AdminPatentes: React.FC = () => {
  ...
  const fetchRecords = async (page: number) => {
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/admin/patentes_manuales?page=${page}`);
    ...
    <Container className="py-5" fluid>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center">
            ...
            <h2 className="fw-bold mb-0">Reporte de Patentes</h2>
        </div>
        <Button variant="success" onClick={() => fetchRecords(currentPage)}>Actualizar</Button>
      </div>
