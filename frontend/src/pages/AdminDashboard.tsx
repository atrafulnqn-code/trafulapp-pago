  ...
  return (
    <Container className="py-5 mt-5">
      ...
      <Row xs={1} md={2} lg={2} className="g-4">
        ...
        <Col>
          <Card className="h-100 shadow-sm border-0 hover-shadow transition-all" style={{ cursor: 'pointer' }} onClick={() => navigate('/admin/db/payments')}>
            <Card.Body className="text-center p-4">
              ...
              <Card.Title className="fw-bold">Pagos Automatizados</Card.Title>
        ...
        {/* Módulo Histórico 19 Ene - 10 Feb */}
        <Col>
          <Card className="h-100 shadow-sm border-0 hover-shadow transition-all" style={{ cursor: 'pointer' }} onClick={() => navigate('/admin/db/historico-19ene-10feb')}>
            <Card.Body className="text-center p-4">
              ...
              <Card.Title className="fw-bold">Datos 19 de Enero a 10 de Febrero 2026</Card.Title>
              <Card.Text className="text-muted small">
                Registro histórico unificado directo desde base de datos con comprobante PDF.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
        ...
        {/* Módulo Rendición */}
        <Col>
          <Card className="h-100 shadow-sm border-0 hover-shadow transition-all" style={{ cursor: 'pointer' }} onClick={() => navigate('/admin/db/rendicion')}>
            <Card.Body className="text-center p-4">
              <div className="text-info mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-journal-check" viewBox="0 0 16 16">
              ...
              <Card.Title className="fw-bold">Rendición</Card.Title>
              <Card.Text className="text-muted small">
                Módulo para gestionar y visualizar rendiciones.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
