...
import AdminDBPayments from './pages/AdminDBPayments';
...
import RecibosSueldos from './pages/RecibosSueldos';
    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route path="/admin/db/payments" element={<AdminDBPayments />} />
          ...
          <Route path="/recursos-humanos/recibos" element={<RecibosSueldos />} />
        </Routes>
      </main>
      {!isAdminPath && <Footer />}
    </div>
